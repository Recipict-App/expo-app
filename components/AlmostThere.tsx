...
export default function AlmostThere() {
  ...
  return (
    <View className=" bg-[#FEC1A6] w-[341] h-[284] rounded-2xl mt-9 pt-[20] justify-between flex">
      <View className="mr-[10px] flex flex-row justify-end">
        <Text className=" font-pps text-2xl w-[250px] text-white text-right">
          Almost There
        </Text>
        <Image
          style={{
